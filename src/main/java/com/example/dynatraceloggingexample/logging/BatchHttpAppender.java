 ...
 */
@Plugin(name = "BatchHttp", category = Node.CATEGORY, elementType = Appender.ELEMENT_TYPE, printObject = true)
public final class BatchHttpAppender extends AbstractAppender {
    ...
    public static class Builder<B extends Builder<B>> extends AbstractAppender.Builder<B>
            implements org.apache.logging.log4j.core.util.Builder<BatchHttpAppender> {
        ...
        @Override
        public BatchHttpAppender build() {
            final HttpManager httpManager = new BatchHttpURLConnectionManager(getConfiguration(),
            ...
            return new BatchHttpAppender(getName(), getLayout(), getFilter(), isIgnoreExceptions(), httpManager,
                    getPropertyArray());
        }
    ...
    private BatchHttpAppender(final String name, final Layout<? extends Serializable> layout, final Filter filter,
